  ...
  render() {
    return html`
      ...
      >
        ...
        <div class="section">
          Your data is yours on Holochain. If someone starts tracking you in any
          way, let the world know
          <b
            ><i
              >and better, tracking-free alternatives will pop up in a matter no
              time</i
            ></b
        ...
        <div class="section">
          The only Cookies needed if desired are those real and tasty ones that
          you are nibbling in front of your screen while enjoying the cozy warm
          feeling of being in full agency about what and with whom you feel
          appropriate to share whatever you do in our shared realm of internet
          based communication.
        </div>
        ...
        <div
          ...
          @click=${async () => {
            this.dispatchEvent(
              new CustomEvent('accepted-to-not-ever-need-to-accept-cookies', {
                composed: true,
                bubbles: true,
              }),
            );
