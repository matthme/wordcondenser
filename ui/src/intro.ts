...
export class IntroSection extends LitElement {
  ...
  renderStepCount() {
    return html`
      <div style="position: fixed; bottom: 30px; right: 30px; color: #929ab9; font-size: 1.2em;">Step ${this.step}/5</div>
    `;
  }
  ...
  renderWelcome() {
    ...
    <h1 style="color: #929ab9; margin-top: 100px; margin-bottom: 120px;">🎉 The Word Condenser is Greeting You! 🎉</h1>

    <div class="column" style="align-items: center; max-width: 1100px; flex: 1; margin: auto;">

      <div class="section" style="margin-bottom: 70px;">I will now lead you through a short intro explaining the most important things
         about the <a href="https://wordcondenser.com" target="_blank">Word Condenser</a>.</div>

      <div class="note" style="background: #a9000033; margin-bottom: 100px;" >💡 That's one of those <b><i>very rare</i></b> moments where you should <b><i>actually</i></b> resist
       your temptation to skip the intro.</div>

      <div
        class="confirm-btn"
        style="align-items: center; margin-top: 30px; margin-bottom: 50px;"
        tabindex="0"
        @click=${async () => { this.step += 1; window.scrollTo(0, 0); }}
        @keypress=${async () => { this.step += 1; window.scrollTo(0, 0); }}
      >
  ...
  renderVocabulary1() {
    return html`
        ...
        <div class="column" style="align-items: center; max-width: 1100px; flex: 1; margin: auto;">
          ...
          <img src="equation.svg" style="width: 1200px;"/>
          ...
          <img src="craving_explainer.svg" style="margin-bottom: 30px;" />
          ...
          <div class="light-bulb-note" style="margin-top: 20px;">
            💡&nbsp<b>peer-to-peer network</b><br><br>
  ...
  renderVocabulary2() {
    return html`
      ...
      <h3 style="color: #FFC64C; opacity: 0.9;">#2 Group</h3>
        ...
        <div class="section">A <span style="color: #FFC64C;">Group</span> is also a dedicated peer-to-peer network. But it is a space to keep track of existing
          Cravings that one may join. It does so by storing the secrets required to join a Craving.</div>

        <img src="how_to_find_them.svg" style="margin-bottom: 30px;" />


        <div class="section">Similar to the case of a Craving, in order to join a <span style="color: #FFC64C;">Group</span>'s network you need to know the name
          of the <span style="color: #FFC64C;">Group</span>, as well as in this case 5 secret words that make up its "network seed".<br><br>
          You can only get those secret words via communication channels outside of the Word Condenser.</div>

        <div class="section">And again,  <b><i>anyone</i> who knows both, the name of the Group and the 5 secret words can join this Group.</b></div>

        <div class="section" style="font-size: 0.7em; margin-top: 50px;">P.s. I'm in fact urgently craving for a better word for what it actually is, instead of "Group".
          Let me know at <a href="mailto:wordcondenser@proton.me" target="_blank">wordcondenser@proton.me</a> with subject "Drop Group" (pun intended) if you condensed a precious drop for it
          and you may see that warming liquid flow right onto the pixels of your screen next time you open me.</div>
  ...
  renderVocabularyOverview() {
    return html`
      ...
      <img src="/world_of_wordcondenser.svg" style="height: 95vh; margin-bottom: 80px;">
  ...
  renderSharingIsCaring() {
    return html`
      ...
      <div class="column" style="align-items: center; max-width: 1100px; flex: 1; margin: auto;">
        ...
        <div class="section" style="text-align: center; margin-bottom: 100px; margin-top: -20px;"><br>
  ...
  renderSharingIsCaring2() {
    return html`
      ...
      <div class="section">
        As you may have realized from the way things work, if you share a Craving with spaces where you don't
        know or trust every single person, a Craving can easily end up in hands that do not treat it with the
        care that it deserves from each and every one of us.
      </div>

      <div class="section">
        If you want a Craving to stay within a certain group of people, it is recommended to be <i>explicit</i> about this
        and dive straight into the cozy cushion of trust that you have in the all-abundant good intent of those beloved peers of yours.
      </div>

      <div class="section">
        So keep your groups tight and warm. It is better to start a new one with some of the people of the
         existing group in it as well, instead of having a group grow to numbers where you lose oversight.
      </div>

      <div class="section">
        As a good rule of thumb: Do not ever let a group grow larger than 10 people.
      </div>
  ...
  renderfrikkinHolochain() {
    return html`
      ...
      <div class="column" style="align-items: center; max-width: 1600px; flex: 1; margin: auto; justify-content: center; height: 100vh;">


        <div style="color: #bfc5de; font-size: 2.8em; margin-bottom: 60px; margin-top: 150px;">
        🚀🚀 It's frikkin' <b>HOLOCHAIN !!</b> 🚀🚀
        </div>

        <div style="color: #bfc5de; font-size: 2em; margin-bottom: 80px;">
          We ain't needin' ads no more to signal to each other what we need and want!
        </div>
        ...
        <div
          ...
          @click=${async () => {
            ...
            this.dispatchEvent(new CustomEvent('intro-finished', {
              composed: true,
              bubbles: true,
            }));
          }}
        ...
        >
            <span style="color: #abb5d6; font-size: 1em;">I'll let it sink in 😍</span>
        </div>
      </div>
  ...
  renderDidYou() {
    return html`
      ...
      <div style="color: #bfc5de; font-size: 1.2em;">
        Did you??
      </div>
