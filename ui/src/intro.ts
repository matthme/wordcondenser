...
export class IntroSection extends LitElement {
    ...
    return html`
      ...
      >
        <div class="section" style="margin-bottom: 70px;">
          You will now be guided through a short intro explaining the most
          important things about the Word Condenser.
        </div>
  ...
  renderVocabulary1() {
    return html`
      ...
      >
        <div class="section">
          At the heart of the Word Condenser are what we call
          <span style="color: #FFC64C;">Cravings</span>.
        </div>

        <div class="section">
          A <span style="color: #FFC64C;">Craving</span> emerges from a (strong)
          desire of a person to have a word for something that there does not
          yet exist a word for.
        </div>

        <div class="section" style="margin-bottom: 0;">
          In order to be able to condense such words from our collective
          atmosphere of imagination, shared experiences, etc. the Word Condenser
          makes use of the following three components:
        </div>

        <img
          src="equation.svg"
          alt="Visualization of the equation Associations + Reflections + Offers = Liquified Human Collective Potential"
          style="width: 1200px;"
        />
        ...
        <div class="section">
          <ul>
            <li>
              <b>Associations: </b><br />A single word that you associate with
              the thing that's looking for a word. Keep it short! It's merely
              our way to palpate our collective space of associations and
              <i>«get a sense of where the fog is dense»</i>.
            </li>
            <li>
              <b>Reflections: </b><br />More in-depth reflections about that
              thing that's looking for a word, where you may branch off into
              open-ended realms of philosophy, science, history and what your
              hearts desire.
            </li>
            <li>
              <b>Offers: </b><br />After having been exposed to associations and
              deep reflections of other peers long enough, it may every so often
              happen that a drop of precious, liquified human collective
              potential (in the form of a word) condenses just right amongst the
              very synapses of yours. In that case you may happily add it to the
              list of "Offers".
            </li>
          </ul>
        </div>
  ...
  renderSharingIsCaring() {
    return html`
      ...
      >
        ...
        >
          <br />
          Once condensed, those words -<br />
          and especially the juicy ones<br />
          may travel far and free like birds<br />
          through our ecologies of mind.<br /><br />
