...
`;
  ...
  renderLeaveGroup() {
    ...
    >
      ...
      >
        <div>
          Leaving the group means that you disable the corresponding cell in
          your Holochain conductor and you will stop synchronizing data with the
          network of peers this group forms together.<br /><br />
          You will not lose any of the cravings that you have already installed
          and that this group kept track of but you will not see any new
          cravings this group adds to its index in the future.<br /><br />
          You can re-enable the group later or permanently delete it by deleting
          the corresponding cell in the Holochain Launcher with the DNA hash<br /><br />
        </div>

        <div
          style="text-align: center; background: #9098b333; font-family: 'Monospace'; padding: 5px; border-radius: 5px; margin-bottom: 40px;"
        >
          ${encodeHashToBase64(this.lobbyStore.service.cellId[0])}
        </div>
        <div>
          If you delete it permanently, you will not be able to ever join this
          group again <i>with this installation of the Word Condenser</i>. You
      ...
      <div class="row">
        ...
        <div
          ...
          @click=${async () => this.leaveGroup()}
          @keypress=${async () => this.leaveGroup()}
          tabindex="0"
        >
    ...
    switch (this._myProfile.value.status) {
      case 'pending':
        return html`
          <div class="column center-content">
            <div style="font-size: 18px; color: #c5cded;">
      ...
      case 'error':
        ...
        return html`
          <div class="column center-content">
            <div
              style="font-size: 20px; color: #c5cded; font-weight: bold; margin-bottom: 30px;"
            >
              Error:
            </div>
            <div
              style="font-size: 18px; color: #c5cded; font-weight: bold; margin-bottom: 30px;"
            >
    ...
    return html`
      ...
      <div style="position: absolute; top: 10px; right: 10px;">
        <my-profile
          ...
          reactive
          @clicked-my-profile=${() => {
            this._viewMode = LobbyViewMode.EditProfile;
          }}
        ></my-profile>
      </div>
        ...
        <div>
          <div class="column" style="align-items: center;">
            ${this.lobbyInfo?.logo_src
              ? html`<img
                  src=${this.lobbyInfo!.logo_src}
                  style="height: 220px; width: 220px; border-radius: 25px; margin: 30px;"
                  alt="Group logo"
                />`
              : html`<div
                  class="column"
      ...
      <div class="column" style="align-items: center; flex: 1;">
        ...
        <div
          class="row"
          style="font-size: 1.5em; font-weight: bold; color: #9098b3; justify-content: center; align-items: center; margin-bottom: 50px;"
        >
        ...
        ${this.lobbyInfo
          ? html`
              ...
              <div
                class="row"
                style="font-size: 1em; color: #9098b3; justify-content: center; align-items: center; margin-bottom: 30px;"
              >
                <span
                  style="margin-left: 20px; border: 1px solid #9098b3; padding: 8px 16px; border-radius: 8px;"
                  >${this.lobbyInfo!.network_seed}</span
                >
                <img
                  src="copy_icon.svg"
              ...
              <div
                style="font-weight: bold; color: #9098b3; margin-bottom: 20px; font-size: 0.9em;"
              >
                Description:
              </div>
              <div
                style="max-width: 800px; text-align: left; color: #9098b3; font-size: 0.9em; margin-bottom: 70px;"
              >
              ...
              ${this.lobbyInfo?.unenforced_rules
                ? html` <div
                      class="row"
                      style="align-items: center; font-weight: bold; color: #9098b3; margin-bottom: 20px; font-size: 0.9em;"
                    >
                      <img
                        src="rules.svg"
                        alt="Rules icon"
              ...
              <div
                class="column"
                style="background: #9098b30e; align-items: center; width: 100vw; padding-bottom: 100px;"
              >
                <div
                  style="font-weight: bold; color: #9098b3; margin-bottom: 20px; font-size: 1em; margin-top: 50px;"
                >
                  Other Members:
                </div>
          ...
          : html`
              <div
                style="margin-bottom: 8px; max-width: 800px; margin-bottom: 150px; margin-top: 40px;"
              >
                <span style="color: #9098b3;"
                  >Could not get Group meta data from peers yet. At least one
                  other group member needs to be online at the same time in
                  order to synchronize data.</span
                >
              </div>
            `}
      </div>
  ...
  renderContent() {
    switch (this._viewMode) {
      ...
      default:
        return html`Unknown LobbyViewMode`;
    }
  }
  ...
  render() {
    ...
    return html`
      <div
        ...
        @click=${() => {
          this._viewMode = LobbyViewMode.LeaveGroup;
        }}
        @keypress=${() => {
          this._viewMode = LobbyViewMode.LeaveGroup;
        }}
      ...
      >
        ...
        <img src="exit_red.svg" alt="Exit Icon" style="height: 30px;" />
      </div>

      <profile-prompt style="display: flex; flex: 1; overflow-y: auto;">
        ${this.renderContent()}
      </profile-prompt>
    `;
  }
