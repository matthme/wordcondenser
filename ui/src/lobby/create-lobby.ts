...
export class CreateLobby extends LitElement {
  ...
  async createLobby() {
    try {
      ...
      (
        this.shadowRoot?.getElementById('create-lobby-button') as MVBButton
      ).disabled = true;
    ...
    return html`
      ...
      <div style="display: flex; flex-direction: column; align-items: center;">
        <div class="box">
          ...
          >
            This will create a <b>new peer-to-peer network</b> that keeps track
            of juicy cravings out in the wild. With
            <b>random secret words</b> that you can share with anyone you want
            to join.<br /><br />#Holochain
            <span
          ...
          <div style="margin-bottom: 30px;">
            <mvb-textarea
              ...
              "
              @input=${(e: CustomEvent) => {
                this._unenforcedRules = (e.target as any).value;
              }}
          ...
          <div
            style="font-size: 19px; line-height: 30px; color: #c5cded; margin-bottom: 20px; max-width: 800px; text-align: left;"
          >
          ...
          />
          <button @click=${() => this._imageFilePicker.click()}>
            Browse Files...
          </button>
          <div>
            ${this._logoSrc
              ? html`<img
                  src=${this._logoSrc ? this._logoSrc : ''}
                  alt="Group logo"
                  style="height: 200px; width: 200px; border-radius: 40px; margin-top: 20px;"
                />`
              : html``}
          </div>
            ...
            >
              <div class="row" style="align-items: center;">
                <span style="margin-left: 12px;"
                  >${this.installing ? 'creating...' : 'Create Group'}</span
                >
              </div>
            </mvb-button>
          </div>
