...
export class HolochainApp extends LitElement {
  ...
  handleRefresh() {
    ...
    switch (this._dashboardMode) {
      ...
      case DashboardMode.CravingView:
        selectedCravingDnaHash = encodeHashToBase64(this._selectedCravingCellId![0]);
        window.localStorage.setItem("selectedCravingDnaHash", selectedCravingDnaHash);
        window.localStorage.setItem("selectedCraving", JSON.stringify(this._selectedCraving));
  ...
  colorSentence(sentence: string) {
    const colors = ["#dd2c32", "#24d300ff", "#11f8f1ff", "#ffe523ff", "#bb54ea"];
  ...
  renderCravings() {
    return html`
      <div class="row" style="margin-bottom: 30px; width: 100%; justify-content: flex-start; margin-left: 10px;">
        <div
          tabindex="0"
  ...
  renderGroups() {
    return html`
      <div id="content" class="column" style="align-items: center; width: 100%; margin-top: 90px;">
        <all-lobbies
          id="all-lobbies"
    ...
    switch (this._dashboardMode) {
      case DashboardMode.Home:
        return html`
          <div style="padding: 40px; align-items: center;" class="column">
              ...
              !!!window.localStorage.getItem("hide-logo")
                ? html`
                  ...
                  <img
                    ...
                    src="word_condenser_logo.svg" class="logo"
                  />
                </div>
                <div style="color: #b1bae0; font-size: 25px; opacity: 0.85; margin-top: -15px; margin-bottom: 70px; font-style: italic; max-width: 1200px;">${this.getSlogan()}</div>
                `
            ...
            ${(lobbies.size === 0 && Object.values(disabledLobbies).length === 0) ? this.renderWelcome() : this.renderDashBoard()}
      ...
      case DashboardMode.Settings:
        return html`
          ...
          <div class="column" style="align-items: center; max-width: 1600px; flex: 1; margin: auto;">
            ...
            <div class="row" style="align-items: center; width: 100%; justify-content: center;">
              ...
              <span style="color: #abb5da; font-size: 0.9em; margin-left: 10px; margin-top: 12px; text-align: left;">
            ...
            >
              <span style="color: #abb5d6; font-size: 1em;">Show Intro Again</span>
            </div>
