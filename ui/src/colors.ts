...
export const rainbowColors = ['#2efc05', '#fcf805', '#0202fc', '#fc0563', '#11f8f1', '#9611fc', '#d80000', '#11aef7', '#00d627'];
...
export function getHexColorForString(input: string) {
  ...
  return rainbowColors[(firstLetterCharCode * lengthOfinput) % (rainbowColors.length)]
}
